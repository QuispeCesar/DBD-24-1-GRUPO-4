...
|*Requerimientos:*|
| Funcionales:|
| - Poder acceder a informes financieros detallados. <br> - Visualizar gráficos y tablas de análisis financiero. <br> - Poder generar informes personalizados según sus necesidades. |
| No Funcionales:|        
| - Seguridad: Acceso seguro a la información financiera. <br> -  Eficiencia: Rapidez en la generación y presentación de informes. <br> - Usabilidad: Interfaz intuitiva para la visualización de datos financieros. |
...
|*Requerimientos:*|
| Funcionales:|
|- Explorar el catálogo de productos. <br> - Realizar búsquedas de productos por categoría o nombre. <br> - Añadir productos al carrito de compras. <br> - Proceder con el proceso de pago de manera segura. |
| No Funcionales:|   
|- Velocidad: Respuesta rápida de la página web al navegar y realizar acciones. <br> - Fiabilidad: Garantía de disponibilidad de la página y funcionalidades en todo momento. <br> - Seguridad: Protección de datos personales y de pago del cliente.|
